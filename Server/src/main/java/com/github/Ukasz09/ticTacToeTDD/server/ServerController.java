...
public class ServerController implements IMsgObserver {
    ...
    public void updateSubscriber(String msg, char signIdentifier) {
        ...
        if (msg.equals(Messages.START_BTN_CLICKED)) {
        ...
        } else if (msg.equals(Messages.CHOSEN_VALID_NAME)) {
            if (otherPlayerMadeChoice) {
                clearLevel();
        ...
        } else if (msg.equals(Messages.AVATAR_BTN_CLICKED)) {
            if (otherPlayerMadeChoice) {
                clearLevel();
        ...
        } else if (msg.equals(Messages.SIGN_BTN_CLICKED)) {
            if (otherPlayerMadeChoice) {
                clearLevel();
        ...
        } else if (msg.contains(Messages.BOARD_SIZE_CHOSEN) || msg.contains(Messages.REPEAT_GAME_BUTTON)) {
            clearLevel();
            resetActualPlayerID();
        ...
        } else if (msg.equals(Messages.END_GAME_BTN_CLICKED))
            server.sendMessage(Messages.CLOSE_MAIN_STAGE, signIdentifier);
        else System.out.println("Unknown message: " + msg);
    }
