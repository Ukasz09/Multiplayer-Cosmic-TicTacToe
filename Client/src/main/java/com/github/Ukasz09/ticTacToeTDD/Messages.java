...
public class Messages {
    ...
    public static final String REPEAT_GAME_BUTTON = "repeat_btn";

    //From server
    public static final String WIN_RESULT = "win";
    public static final String DELIMITER = ":";

    public static final String SCENE_TO_NICK_PAGE = "change_scene_to_nick_choose";
    public static final String SCENE_TO_BOARD_PAGE = "change_scene_to_board";
    public static final String SCENE_TO_WINNER_PAGE = "scene_to_winner_page";
    public static final String SCENE_TO_DRAW_PAGE = "scene_to_draw_page";
    public static final String SCENE_TO_AVATAR_PAGE = "scene_to_avatar_page";
    public static final String SCENE_TO_SIGN_CHOOSE_PAGE = "scene_to_sign_page";
    public static final String SCENE_TO_BOARD_SIZE_PAGE = "scene_to_board_size_page";

    public static final String CLOSE_MAIN_STAGE = "close_main_stage";
    public static final String CLEAR_ACTION_NODES = "clear_action_nodes";
    public static final String RESET_ACTUAL_PLAYER_ID = "reset_actual_player_id";
